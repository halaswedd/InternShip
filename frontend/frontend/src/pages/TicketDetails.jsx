      ...
      <div className="td-page">
        <div className="td-top-actions">
          <button
            ...
            onClick={() => updateTicket({ status_id: "5" })}
          >
            <X size={15} /> Close
          </button>

          <button
            className="td-resolve-btn"
            onClick={() => updateTicket({ status_id: "4" })}
          >
        ...
        <div className="td-card td-header-card">
          <div className="td-header-left">
            <div className="td-tags">
              ...
              <span
                className={`td-status-badge status-${ticket.status
                  .toLowerCase()
                  .replace(" ", "-")}`}
              >
                • {ticket.status}
          ...
          <div className="td-card">
            ...
            <div className="td-requester">
              ...
              <div>
                ...
                <p className="td-requester-email">
