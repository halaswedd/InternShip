...
function AdminPanel() {
  ...
  const fetchUsers = async () => {
    try {
      const response = await fetch(
        "https://affectionate-freedom-production-e166.up.railway.app/get_users.php",
        {
          method: "GET",
  ...
  const fetchLogs = async () => {
    try {
      const response = await fetch(
        "https://affectionate-freedom-production-e166.up.railway.app/get_activity_logs.php",
        {
          method: "GET",
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  const fetchCategories = async () => {
    try {
      const response = await fetch(
        "https://affectionate-freedom-production-e166.up.railway.app/get_categories.php",
        {
          method: "GET",
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  const fetchAdminStats = async () => {
    try {
      const response = await fetch(
        "https://affectionate-freedom-production-e166.up.railway.app/get_admin_stats.php",
        {
          method: "GET",
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  const handleRoleChange = async (userId, newRoleId) => {
    ...
    try {
      const response = await fetch(
        "https://affectionate-freedom-production-e166.up.railway.app/update_user_role.php",
        {
          method: "POST",
          headers: {
  ...
  const handleAddUser = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://affectionate-freedom-production-e166.up.railway.app/add_user.php",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleDeleteUser = async (userId) => {
    ...
    try {
      const response = await fetch(
        "https://affectionate-freedom-production-e166.up.railway.app/delete_user.php",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleAddCategory = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://affectionate-freedom-production-e166.up.railway.app/manage_categories.php",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
      ...
      <div className="ap-page">
        <div className="ap-widgets">
          <div className="ap-widget">
            <div className="ap-widget-top">
              ...
              <div className="ap-widget-icon blue">
                <Users size={16} />
              </div>
            </div>
            <span className="ap-widget-number">
          ...
          <div className="ap-widget">
            <div className="ap-widget-top">
              ...
              <div className="ap-widget-icon orange">
                <Ticket size={16} />
              </div>
            </div>
            <span className="ap-widget-number">
              {adminStats?.open_tickets ?? "—"}
            </span>
          </div>
          ...
          <div className="ap-widget">
            <div className="ap-widget-top">
              ...
              <div className="ap-widget-icon purple">
                <Headphones size={16} />
              </div>
            </div>
            <span className="ap-widget-number">
              {adminStats?.support_agents ?? "—"}
            </span>
          </div>
          ...
          <div className="ap-widget">
            <div className="ap-widget-top">
              ...
              <div className="ap-widget-icon green">
                <CheckCircle2 size={16} />
              </div>
            </div>
            <span className="ap-widget-status">
              {adminStats?.error ? "Issue Detected" : "Operational"}
            </span>
          </div>
        </div>
        ...
        <div className="ap-row">
          ...
          <div className="ap-panel ap-logs-panel">
            ...
            <div className="ap-logs-list">
              {logs.length === 0 && (
                <p className="ap-muted">No activity yet.</p>
              )}

              {logs.slice(0, 6).map((log) => (
                <div className="ap-log-row" key={log.id}>
                  <p className="ap-log-action">
        ...
        <div className="ap-row ap-row-three">
          ...
          <div className="ap-panel">
            ...
            <p className="ap-muted" style={{ marginBottom: 14 }}>
              Generate comprehensive data visualizations for stakeholders.
            </p>

            <button className="ap-report-btn" onClick={handlePrint}>
